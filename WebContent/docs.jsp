    ...
    pageEncoding="ISO-8859-1"%>
		...
		<div style="margin-left: 25px; margin-right: 25px; text-align: left;">
			...
			<p id="node">
				...
				After you do that, you can simply use the dialect api by doing: <pre>dialect.ask("something to ask the dialect", function(response) { console.log(response); });</pre>This calls your dialect instance's ask method and runs the callback.<br>
